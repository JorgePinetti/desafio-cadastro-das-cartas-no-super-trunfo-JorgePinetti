...
int main()
{
    ...
    superPoder1 = (float)populacaoCidade1 + areaCidade1 + pibCidade1 + (float)turismoCidade1;
    ...
    superPoder2 = (float)populacaoCidade2 + areaCidade2 + pibCidade2 + (float)turismoCidade2;
